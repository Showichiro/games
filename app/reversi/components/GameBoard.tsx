...
export default function GameBoard({
  ...
  return (
    ...
    >
      <div className="grid grid-cols-8 gap-1 sm:gap-2 bg-green-900 p-1 sm:p-2 rounded w-64 h-64 sm:w-72 sm:h-72 md:w-80 md:h-80 lg:w-96 lg:h-96 xl:w-[400px] xl:h-[400px] max-w-[85vw] max-h-[85vw]">
